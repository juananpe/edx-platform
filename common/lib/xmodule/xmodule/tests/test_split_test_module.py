...
class SplitTestModuleStudioTest(SplitTestModuleTest):
    ...
    def test_validation_messages(self):
        ...
        verify_validation_message(
            messages[0],
            u"This content experiment has not been associated with a group configuration yet.",
        ...
        verify_validation_message(
            messages[0],
            u"Groups that have been added are not shown.",
        ...
        verify_validation_message(
            messages[0],
            u"Inactive groups are present. You can move content into active groups or delete unwanted groups.",
            ValidationMessageType.warning
        )
        ...
        verify_validation_message(
            messages[0],
            u"This experiment uses a group configuration that was deleted. "
